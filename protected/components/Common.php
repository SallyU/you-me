...
//            '♠' => '&spades;', '♣' => '&clubs;', '♥' => '&hearts;', '♦' => '&diams;',
    ...
    */
    ...
    public static function isMobile($mobile) {
        if (!is_numeric(self::trimAll($mobile))) {
            return false;
        }
     ...
     * 生成手机验证码
     */
    public static function generate_mobile_code($length = 6) {
     ...
     * 手机验证码生成函数
     */
    public static function get_mobile_code($len = 6)
    {
        $forbidden_num = "1989:10086:12590:1259:10010:10001:10000:";//去除随机生成的禁止的号码
        do
        {
     ...
     * @return String
     */
    public static function encode($string = '', $skey = 'canyian') {
     ...
     * @return String
     */
    public static function decode($string = '', $skey = 'canyian') {
